#Escreva um script que mostre na tela o preço de um produto associado a uma 
#categoria especificada pelo usuário. Utilize como referência as informações a seguir. 
#Caso o usuário não digite uma categoria válida (número entre 1 e 10) mostre na tela 
